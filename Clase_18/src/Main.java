...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        argentina.convocar(new Jugador(delantero,"Agüero",9));
        ...
        System.out.println(argentina.obtenerReservas());
        System.out.println("La cantidad de arqueros de la selección es: " + argentina.cantJugadores("Aguatero"));
